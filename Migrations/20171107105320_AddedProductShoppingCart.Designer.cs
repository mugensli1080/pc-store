...
namespace pcstore.Migrations
{
    ...
    [Migration("20171107105320_AddedProductShoppingCart")]
    partial class AddedProductShoppingCart
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pc_store.Core.Models.ProductShoppingCart", b =>
                {
                    b.Property<int>("ProductId");
            ...
            modelBuilder.Entity("pc_store.Core.Models.ProductShoppingCart", b =>
                {
                    b.HasOne("pc_store.Core.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("pc_store.Core.Models.ShoppingCart", "ShoppingCart")
                        .WithMany()
                        .HasForeignKey("ShoppingCartId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
